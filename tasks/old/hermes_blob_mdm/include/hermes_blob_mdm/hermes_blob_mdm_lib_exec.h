...
void Dup(u32 method, Task *orig_task, std::vector<LPointer<Task>> &dups) override {
  switch (method) {
    case Method::kConstruct: {
      chi::CALL_DUPLICATE(reinterpret_cast<ConstructTask*>(orig_task), dups);
      break;
    }
    case Method::kDestruct: {
      chi::CALL_DUPLICATE(reinterpret_cast<DestructTask*>(orig_task), dups);
      break;
    }
    case Method::kPutBlob: {
      chi::CALL_DUPLICATE(reinterpret_cast<PutBlobTask*>(orig_task), dups);
      break;
    }
    case Method::kGetBlob: {
      chi::CALL_DUPLICATE(reinterpret_cast<GetBlobTask*>(orig_task), dups);
      break;
    }
    case Method::kTruncateBlob: {
      chi::CALL_DUPLICATE(reinterpret_cast<TruncateBlobTask*>(orig_task), dups);
      break;
    }
    case Method::kDestroyBlob: {
      chi::CALL_DUPLICATE(reinterpret_cast<DestroyBlobTask*>(orig_task), dups);
      break;
    }
    case Method::kTagBlob: {
      chi::CALL_DUPLICATE(reinterpret_cast<TagBlobTask*>(orig_task), dups);
      break;
    }
    case Method::kBlobHasTag: {
      chi::CALL_DUPLICATE(reinterpret_cast<BlobHasTagTask*>(orig_task), dups);
      break;
    }
    case Method::kGetBlobId: {
      chi::CALL_DUPLICATE(reinterpret_cast<GetBlobIdTask*>(orig_task), dups);
      break;
    }
    case Method::kGetOrCreateBlobId: {
      chi::CALL_DUPLICATE(reinterpret_cast<GetOrCreateBlobIdTask*>(orig_task), dups);
      break;
    }
    case Method::kGetBlobName: {
      chi::CALL_DUPLICATE(reinterpret_cast<GetBlobNameTask*>(orig_task), dups);
      break;
    }
    case Method::kGetBlobSize: {
      chi::CALL_DUPLICATE(reinterpret_cast<GetBlobSizeTask*>(orig_task), dups);
      break;
    }
    case Method::kGetBlobScore: {
      chi::CALL_DUPLICATE(reinterpret_cast<GetBlobScoreTask*>(orig_task), dups);
      break;
    }
    case Method::kGetBlobBuffers: {
      chi::CALL_DUPLICATE(reinterpret_cast<GetBlobBuffersTask*>(orig_task), dups);
      break;
    }
    case Method::kRenameBlob: {
      chi::CALL_DUPLICATE(reinterpret_cast<RenameBlobTask*>(orig_task), dups);
      break;
    }
    case Method::kReorganizeBlob: {
      chi::CALL_DUPLICATE(reinterpret_cast<ReorganizeBlobTask*>(orig_task), dups);
      break;
    }
    case Method::kSetBucketMdm: {
      chi::CALL_DUPLICATE(reinterpret_cast<SetBucketMdmTask*>(orig_task), dups);
      break;
    }
    case Method::kFlushData: {
      chi::CALL_DUPLICATE(reinterpret_cast<FlushDataTask*>(orig_task), dups);
      break;
    }
    case Method::kPollBlobMetadata: {
      chi::CALL_DUPLICATE(reinterpret_cast<PollBlobMetadataTask*>(orig_task), dups);
      break;
    }
    case Method::kPollTargetMetadata: {
      chi::CALL_DUPLICATE(reinterpret_cast<PollTargetMetadataTask*>(orig_task), dups);
      break;
    }
  }
}
...
void DupEnd(u32 method, u32 replica, Task *orig_task, Task *dup_task) override {
  switch (method) {
    case Method::kConstruct: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<ConstructTask*>(orig_task), reinterpret_cast<ConstructTask*>(dup_task));
      break;
    }
    case Method::kDestruct: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<DestructTask*>(orig_task), reinterpret_cast<DestructTask*>(dup_task));
      break;
    }
    case Method::kPutBlob: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<PutBlobTask*>(orig_task), reinterpret_cast<PutBlobTask*>(dup_task));
      break;
    }
    case Method::kGetBlob: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<GetBlobTask*>(orig_task), reinterpret_cast<GetBlobTask*>(dup_task));
      break;
    }
    case Method::kTruncateBlob: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<TruncateBlobTask*>(orig_task), reinterpret_cast<TruncateBlobTask*>(dup_task));
      break;
    }
    case Method::kDestroyBlob: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<DestroyBlobTask*>(orig_task), reinterpret_cast<DestroyBlobTask*>(dup_task));
      break;
    }
    case Method::kTagBlob: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<TagBlobTask*>(orig_task), reinterpret_cast<TagBlobTask*>(dup_task));
      break;
    }
    case Method::kBlobHasTag: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<BlobHasTagTask*>(orig_task), reinterpret_cast<BlobHasTagTask*>(dup_task));
      break;
    }
    case Method::kGetBlobId: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<GetBlobIdTask*>(orig_task), reinterpret_cast<GetBlobIdTask*>(dup_task));
      break;
    }
    case Method::kGetOrCreateBlobId: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<GetOrCreateBlobIdTask*>(orig_task), reinterpret_cast<GetOrCreateBlobIdTask*>(dup_task));
      break;
    }
    case Method::kGetBlobName: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<GetBlobNameTask*>(orig_task), reinterpret_cast<GetBlobNameTask*>(dup_task));
      break;
    }
    case Method::kGetBlobSize: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<GetBlobSizeTask*>(orig_task), reinterpret_cast<GetBlobSizeTask*>(dup_task));
      break;
    }
    case Method::kGetBlobScore: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<GetBlobScoreTask*>(orig_task), reinterpret_cast<GetBlobScoreTask*>(dup_task));
      break;
    }
    case Method::kGetBlobBuffers: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<GetBlobBuffersTask*>(orig_task), reinterpret_cast<GetBlobBuffersTask*>(dup_task));
      break;
    }
    case Method::kRenameBlob: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<RenameBlobTask*>(orig_task), reinterpret_cast<RenameBlobTask*>(dup_task));
      break;
    }
    case Method::kReorganizeBlob: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<ReorganizeBlobTask*>(orig_task), reinterpret_cast<ReorganizeBlobTask*>(dup_task));
      break;
    }
    case Method::kSetBucketMdm: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<SetBucketMdmTask*>(orig_task), reinterpret_cast<SetBucketMdmTask*>(dup_task));
      break;
    }
    case Method::kFlushData: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<FlushDataTask*>(orig_task), reinterpret_cast<FlushDataTask*>(dup_task));
      break;
    }
    case Method::kPollBlobMetadata: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<PollBlobMetadataTask*>(orig_task), reinterpret_cast<PollBlobMetadataTask*>(dup_task));
      break;
    }
    case Method::kPollTargetMetadata: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<PollTargetMetadataTask*>(orig_task), reinterpret_cast<PollTargetMetadataTask*>(dup_task));
      break;
    }
  }
}
...
void ReplicateStart(u32 method, u32 count, Task *task) override {
  switch (method) {
    case Method::kConstruct: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<ConstructTask*>(task));
      break;
    }
    case Method::kDestruct: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<DestructTask*>(task));
      break;
    }
    case Method::kPutBlob: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<PutBlobTask*>(task));
      break;
    }
    case Method::kGetBlob: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<GetBlobTask*>(task));
      break;
    }
    case Method::kTruncateBlob: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<TruncateBlobTask*>(task));
      break;
    }
    case Method::kDestroyBlob: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<DestroyBlobTask*>(task));
      break;
    }
    case Method::kTagBlob: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<TagBlobTask*>(task));
      break;
    }
    case Method::kBlobHasTag: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<BlobHasTagTask*>(task));
      break;
    }
    case Method::kGetBlobId: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<GetBlobIdTask*>(task));
      break;
    }
    case Method::kGetOrCreateBlobId: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<GetOrCreateBlobIdTask*>(task));
      break;
    }
    case Method::kGetBlobName: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<GetBlobNameTask*>(task));
      break;
    }
    case Method::kGetBlobSize: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<GetBlobSizeTask*>(task));
      break;
    }
    case Method::kGetBlobScore: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<GetBlobScoreTask*>(task));
      break;
    }
    case Method::kGetBlobBuffers: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<GetBlobBuffersTask*>(task));
      break;
    }
    case Method::kRenameBlob: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<RenameBlobTask*>(task));
      break;
    }
    case Method::kReorganizeBlob: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<ReorganizeBlobTask*>(task));
      break;
    }
    case Method::kSetBucketMdm: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<SetBucketMdmTask*>(task));
      break;
    }
    case Method::kFlushData: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<FlushDataTask*>(task));
      break;
    }
    case Method::kPollBlobMetadata: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<PollBlobMetadataTask*>(task));
      break;
    }
    case Method::kPollTargetMetadata: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<PollTargetMetadataTask*>(task));
      break;
    }
  }
}
...
void ReplicateEnd(u32 method, Task *task) override {
  switch (method) {
    case Method::kConstruct: {
      chi::CALL_REPLICA_END(reinterpret_cast<ConstructTask*>(task));
      break;
    }
    case Method::kDestruct: {
      chi::CALL_REPLICA_END(reinterpret_cast<DestructTask*>(task));
      break;
    }
    case Method::kPutBlob: {
      chi::CALL_REPLICA_END(reinterpret_cast<PutBlobTask*>(task));
      break;
    }
    case Method::kGetBlob: {
      chi::CALL_REPLICA_END(reinterpret_cast<GetBlobTask*>(task));
      break;
    }
    case Method::kTruncateBlob: {
      chi::CALL_REPLICA_END(reinterpret_cast<TruncateBlobTask*>(task));
      break;
    }
    case Method::kDestroyBlob: {
      chi::CALL_REPLICA_END(reinterpret_cast<DestroyBlobTask*>(task));
      break;
    }
    case Method::kTagBlob: {
      chi::CALL_REPLICA_END(reinterpret_cast<TagBlobTask*>(task));
      break;
    }
    case Method::kBlobHasTag: {
      chi::CALL_REPLICA_END(reinterpret_cast<BlobHasTagTask*>(task));
      break;
    }
    case Method::kGetBlobId: {
      chi::CALL_REPLICA_END(reinterpret_cast<GetBlobIdTask*>(task));
      break;
    }
    case Method::kGetOrCreateBlobId: {
      chi::CALL_REPLICA_END(reinterpret_cast<GetOrCreateBlobIdTask*>(task));
      break;
    }
    case Method::kGetBlobName: {
      chi::CALL_REPLICA_END(reinterpret_cast<GetBlobNameTask*>(task));
      break;
    }
    case Method::kGetBlobSize: {
      chi::CALL_REPLICA_END(reinterpret_cast<GetBlobSizeTask*>(task));
      break;
    }
    case Method::kGetBlobScore: {
      chi::CALL_REPLICA_END(reinterpret_cast<GetBlobScoreTask*>(task));
      break;
    }
    case Method::kGetBlobBuffers: {
      chi::CALL_REPLICA_END(reinterpret_cast<GetBlobBuffersTask*>(task));
      break;
    }
    case Method::kRenameBlob: {
      chi::CALL_REPLICA_END(reinterpret_cast<RenameBlobTask*>(task));
      break;
    }
    case Method::kReorganizeBlob: {
      chi::CALL_REPLICA_END(reinterpret_cast<ReorganizeBlobTask*>(task));
      break;
    }
    case Method::kSetBucketMdm: {
      chi::CALL_REPLICA_END(reinterpret_cast<SetBucketMdmTask*>(task));
      break;
    }
    case Method::kFlushData: {
      chi::CALL_REPLICA_END(reinterpret_cast<FlushDataTask*>(task));
      break;
    }
    case Method::kPollBlobMetadata: {
      chi::CALL_REPLICA_END(reinterpret_cast<PollBlobMetadataTask*>(task));
      break;
    }
    case Method::kPollTargetMetadata: {
      chi::CALL_REPLICA_END(reinterpret_cast<PollTargetMetadataTask*>(task));
      break;
    }
  }
}
...
u32 GetGroup(u32 method, Task *task, chi::charbuf &group) override {
  switch (method) {
    case Method::kConstruct: {
