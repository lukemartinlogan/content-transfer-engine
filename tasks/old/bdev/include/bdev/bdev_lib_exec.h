...
void Dup(u32 method, Task *orig_task, std::vector<LPointer<Task>> &dups) override {
  switch (method) {
    ...
    case Method::kWrite: {
      chi::CALL_DUPLICATE(reinterpret_cast<WriteTask*>(orig_task), dups);
      break;
    }
    case Method::kRead: {
      chi::CALL_DUPLICATE(reinterpret_cast<ReadTask*>(orig_task), dups);
      break;
    }
    case Method::kAllocate: {
      chi::CALL_DUPLICATE(reinterpret_cast<AllocateTask*>(orig_task), dups);
      break;
    }
    case Method::kFree: {
      chi::CALL_DUPLICATE(reinterpret_cast<FreeTask*>(orig_task), dups);
      break;
    }
    case Method::kStatBdev: {
      chi::CALL_DUPLICATE(reinterpret_cast<StatBdevTask*>(orig_task), dups);
      break;
    }
    case Method::kUpdateScore: {
      chi::CALL_DUPLICATE(reinterpret_cast<UpdateScoreTask*>(orig_task), dups);
      break;
    }
  }
}
...
void DupEnd(u32 method, u32 replica, Task *orig_task, Task *dup_task) override {
  switch (method) {
    ...
    case Method::kWrite: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<WriteTask*>(orig_task), reinterpret_cast<WriteTask*>(dup_task));
      break;
    }
    case Method::kRead: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<ReadTask*>(orig_task), reinterpret_cast<ReadTask*>(dup_task));
      break;
    }
    case Method::kAllocate: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<AllocateTask*>(orig_task), reinterpret_cast<AllocateTask*>(dup_task));
      break;
    }
    case Method::kFree: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<FreeTask*>(orig_task), reinterpret_cast<FreeTask*>(dup_task));
      break;
    }
    case Method::kStatBdev: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<StatBdevTask*>(orig_task), reinterpret_cast<StatBdevTask*>(dup_task));
      break;
    }
    case Method::kUpdateScore: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<UpdateScoreTask*>(orig_task), reinterpret_cast<UpdateScoreTask*>(dup_task));
      break;
    }
  }
}
...
void ReplicateStart(u32 method, u32 count, Task *task) override {
  switch (method) {
    ...
    case Method::kWrite: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<WriteTask*>(task));
      break;
    }
    case Method::kRead: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<ReadTask*>(task));
      break;
    }
    case Method::kAllocate: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<AllocateTask*>(task));
      break;
    }
    case Method::kFree: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<FreeTask*>(task));
      break;
    }
    case Method::kStatBdev: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<StatBdevTask*>(task));
      break;
    }
    case Method::kUpdateScore: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<UpdateScoreTask*>(task));
      break;
    }
  }
}
...
void ReplicateEnd(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kWrite: {
      chi::CALL_REPLICA_END(reinterpret_cast<WriteTask*>(task));
      break;
    }
    case Method::kRead: {
      chi::CALL_REPLICA_END(reinterpret_cast<ReadTask*>(task));
      break;
    }
    case Method::kAllocate: {
      chi::CALL_REPLICA_END(reinterpret_cast<AllocateTask*>(task));
      break;
    }
    case Method::kFree: {
      chi::CALL_REPLICA_END(reinterpret_cast<FreeTask*>(task));
      break;
    }
    case Method::kStatBdev: {
      chi::CALL_REPLICA_END(reinterpret_cast<StatBdevTask*>(task));
      break;
    }
    case Method::kUpdateScore: {
      chi::CALL_REPLICA_END(reinterpret_cast<UpdateScoreTask*>(task));
      break;
    }
  }
}
