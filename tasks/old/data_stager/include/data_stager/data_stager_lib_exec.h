...
void Dup(u32 method, Task *orig_task, std::vector<LPointer<Task>> &dups) override {
  switch (method) {
    ...
    case Method::kRegisterStager: {
      chi::CALL_DUPLICATE(reinterpret_cast<RegisterStagerTask*>(orig_task), dups);
      break;
    }
    case Method::kUnregisterStager: {
      chi::CALL_DUPLICATE(reinterpret_cast<UnregisterStagerTask*>(orig_task), dups);
      break;
    }
    case Method::kStageIn: {
      chi::CALL_DUPLICATE(reinterpret_cast<StageInTask*>(orig_task), dups);
      break;
    }
    case Method::kStageOut: {
      chi::CALL_DUPLICATE(reinterpret_cast<StageOutTask*>(orig_task), dups);
      break;
    }
    case Method::kUpdateSize: {
...
void DupEnd(u32 method, u32 replica, Task *orig_task, Task *dup_task) override {
  switch (method) {
    ...
    case Method::kRegisterStager: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<RegisterStagerTask*>(orig_task), reinterpret_cast<RegisterStagerTask*>(dup_task));
      break;
    }
    case Method::kUnregisterStager: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<UnregisterStagerTask*>(orig_task), reinterpret_cast<UnregisterStagerTask*>(dup_task));
      break;
    }
    case Method::kStageIn: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<StageInTask*>(orig_task), reinterpret_cast<StageInTask*>(dup_task));
      break;
    }
    case Method::kStageOut: {
      chi::CALL_DUPLICATE_END(replica, reinterpret_cast<StageOutTask*>(orig_task), reinterpret_cast<StageOutTask*>(dup_task));
      break;
    }
    case Method::kUpdateSize: {
...
void ReplicateStart(u32 method, u32 count, Task *task) override {
  switch (method) {
    ...
    case Method::kRegisterStager: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<RegisterStagerTask*>(task));
      break;
    }
    case Method::kUnregisterStager: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<UnregisterStagerTask*>(task));
      break;
    }
    case Method::kStageIn: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<StageInTask*>(task));
      break;
    }
    case Method::kStageOut: {
      chi::CALL_REPLICA_START(count, reinterpret_cast<StageOutTask*>(task));
      break;
    }
    case Method::kUpdateSize: {
...
void ReplicateEnd(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kRegisterStager: {
      chi::CALL_REPLICA_END(reinterpret_cast<RegisterStagerTask*>(task));
      break;
    }
    case Method::kUnregisterStager: {
      chi::CALL_REPLICA_END(reinterpret_cast<UnregisterStagerTask*>(task));
      break;
    }
    case Method::kStageIn: {
      chi::CALL_REPLICA_END(reinterpret_cast<StageInTask*>(task));
      break;
    }
    case Method::kStageOut: {
      chi::CALL_REPLICA_END(reinterpret_cast<StageOutTask*>(task));
      break;
    }
    case Method::kUpdateSize: {
