...
void Run(u32 method, Task *task, RunContext &rctx) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      ParseAccessPattern(reinterpret_cast<ParseAccessPatternTask *>(task), rctx);
      break;
    }
  }
}
...
void Monitor(u32 mode, Task *task, RunContext &rctx) override {
  switch (task->method_) {
    ...
    case Method::kParseAccessPattern: {
      MonitorParseAccessPattern(mode, reinterpret_cast<ParseAccessPatternTask *>(task), rctx);
      break;
    }
  }
}
...
void Del(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      HRUN_CLIENT->DelTask<ParseAccessPatternTask>(reinterpret_cast<ParseAccessPatternTask *>(task));
      break;
    }
  }
}
...
void Dup(u32 method, Task *orig_task, std::vector<LPointer<Task>> &dups) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      hrun::CALL_DUPLICATE(reinterpret_cast<ParseAccessPatternTask*>(orig_task), dups);
      break;
    }
  }
}
...
void DupEnd(u32 method, u32 replica, Task *orig_task, Task *dup_task) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      hrun::CALL_DUPLICATE_END(replica, reinterpret_cast<ParseAccessPatternTask*>(orig_task), reinterpret_cast<ParseAccessPatternTask*>(dup_task));
      break;
    }
  }
}
...
void ReplicateStart(u32 method, u32 count, Task *task) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      hrun::CALL_REPLICA_START(count, reinterpret_cast<ParseAccessPatternTask*>(task));
      break;
    }
  }
}
...
void ReplicateEnd(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      hrun::CALL_REPLICA_END(reinterpret_cast<ParseAccessPatternTask*>(task));
      break;
    }
  }
}
...
std::vector<DataTransfer> SaveStart(u32 method, BinaryOutputArchive<true> &ar, Task *task) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      ar << *reinterpret_cast<ParseAccessPatternTask*>(task);
      break;
    }
  }
  return ar.Get();
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      task_ptr.ptr_ = HRUN_CLIENT->NewEmptyTask<ParseAccessPatternTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<ParseAccessPatternTask*>(task_ptr.ptr_);
      break;
    }
  }
  return task_ptr;
...
void LoadEnd(u32 replica, u32 method, BinaryInputArchive<false> &ar, Task *task) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      ar.Deserialize(replica, *reinterpret_cast<ParseAccessPatternTask*>(task));
      break;
    }
  }
}
...
u32 GetGroup(u32 method, Task *task, hshm::charbuf &group) override {
  switch (method) {
    ...
    case Method::kParseAccessPattern: {
      return reinterpret_cast<ParseAccessPatternTask*>(task)->GetGroup(group);
    }
  }
  return -1;
}
