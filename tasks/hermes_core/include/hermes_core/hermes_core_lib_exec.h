  ...
  switch (method) {
    ...
    case Method::kTagGetContainedBlobIds: {
      TagGetContainedBlobIds(
          reinterpret_cast<TagGetContainedBlobIdsTask *>(task), rctx);
      break;
    }
    ...
    case Method::kPollTargetMetadata: {
      PollTargetMetadata(reinterpret_cast<PollTargetMetadataTask *>(task),
                         rctx);
      break;
    }
...
void Monitor(MonitorModeId mode, MethodId method, Task *task,
  ...
  switch (method) {
    ...
    case Method::kGetOrCreateTag: {
      MonitorGetOrCreateTag(mode, reinterpret_cast<GetOrCreateTagTask *>(task),
                            rctx);
      break;
    }
    case Method::kGetTagId: {
    ...
    case Method::kTagRemoveBlob: {
      MonitorTagRemoveBlob(mode, reinterpret_cast<TagRemoveBlobTask *>(task),
                           rctx);
      break;
    }
    case Method::kTagClearBlobs: {
      MonitorTagClearBlobs(mode, reinterpret_cast<TagClearBlobsTask *>(task),
                           rctx);
      break;
    }
    case Method::kTagGetSize: {
    ...
    case Method::kTagUpdateSize: {
      MonitorTagUpdateSize(mode, reinterpret_cast<TagUpdateSizeTask *>(task),
                           rctx);
      break;
    }
    case Method::kTagGetContainedBlobIds: {
      MonitorTagGetContainedBlobIds(
          mode, reinterpret_cast<TagGetContainedBlobIdsTask *>(task), rctx);
      break;
    }
    case Method::kTagFlush: {
    ...
    case Method::kGetOrCreateBlobId: {
      MonitorGetOrCreateBlobId(
          mode, reinterpret_cast<GetOrCreateBlobIdTask *>(task), rctx);
      break;
    }
    case Method::kGetBlobId: {
    ...
    case Method::kGetBlobScore: {
      MonitorGetBlobScore(mode, reinterpret_cast<GetBlobScoreTask *>(task),
                          rctx);
      break;
    }
    case Method::kGetBlobBuffers: {
      MonitorGetBlobBuffers(mode, reinterpret_cast<GetBlobBuffersTask *>(task),
                            rctx);
      break;
    }
    case Method::kPutBlob: {
    ...
    case Method::kTruncateBlob: {
      MonitorTruncateBlob(mode, reinterpret_cast<TruncateBlobTask *>(task),
                          rctx);
      break;
    }
    case Method::kDestroyBlob: {
    ...
    case Method::kReorganizeBlob: {
      MonitorReorganizeBlob(mode, reinterpret_cast<ReorganizeBlobTask *>(task),
                            rctx);
      break;
    }
    case Method::kFlushBlob: {
    ...
    case Method::kPollBlobMetadata: {
      MonitorPollBlobMetadata(
          mode, reinterpret_cast<PollBlobMetadataTask *>(task), rctx);
      break;
    }
    case Method::kPollTargetMetadata: {
      MonitorPollTargetMetadata(
          mode, reinterpret_cast<PollTargetMetadataTask *>(task), rctx);
      break;
    }
    case Method::kPollTagMetadata: {
      MonitorPollTagMetadata(
          mode, reinterpret_cast<PollTagMetadataTask *>(task), rctx);
      break;
    }
    case Method::kPollAccessPattern: {
      MonitorPollAccessPattern(
          mode, reinterpret_cast<PollAccessPatternTask *>(task), rctx);
      break;
    }
    case Method::kRegisterStager: {
      MonitorRegisterStager(mode, reinterpret_cast<RegisterStagerTask *>(task),
                            rctx);
      break;
    }
    case Method::kUnregisterStager: {
      MonitorUnregisterStager(
          mode, reinterpret_cast<UnregisterStagerTask *>(task), rctx);
      break;
    }
    case Method::kStageIn: {
...
void Del(const hipc::MemContext &mctx, u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kGetOrCreateTag: {
      CHI_CLIENT->DelTask<GetOrCreateTagTask>(
          mctx, reinterpret_cast<GetOrCreateTagTask *>(task));
      break;
    }
    case Method::kGetTagId: {
      CHI_CLIENT->DelTask<GetTagIdTask>(mctx,
                                        reinterpret_cast<GetTagIdTask *>(task));
      break;
    }
    case Method::kGetTagName: {
      CHI_CLIENT->DelTask<GetTagNameTask>(
          mctx, reinterpret_cast<GetTagNameTask *>(task));
      break;
    }
    case Method::kDestroyTag: {
      CHI_CLIENT->DelTask<DestroyTagTask>(
          mctx, reinterpret_cast<DestroyTagTask *>(task));
      break;
    }
    case Method::kTagAddBlob: {
      CHI_CLIENT->DelTask<TagAddBlobTask>(
          mctx, reinterpret_cast<TagAddBlobTask *>(task));
      break;
    }
    case Method::kTagRemoveBlob: {
      CHI_CLIENT->DelTask<TagRemoveBlobTask>(
          mctx, reinterpret_cast<TagRemoveBlobTask *>(task));
      break;
    }
    case Method::kTagClearBlobs: {
      CHI_CLIENT->DelTask<TagClearBlobsTask>(
          mctx, reinterpret_cast<TagClearBlobsTask *>(task));
      break;
    }
    case Method::kTagGetSize: {
      CHI_CLIENT->DelTask<TagGetSizeTask>(
          mctx, reinterpret_cast<TagGetSizeTask *>(task));
      break;
    }
    case Method::kTagUpdateSize: {
      CHI_CLIENT->DelTask<TagUpdateSizeTask>(
          mctx, reinterpret_cast<TagUpdateSizeTask *>(task));
      break;
    }
    case Method::kTagGetContainedBlobIds: {
      CHI_CLIENT->DelTask<TagGetContainedBlobIdsTask>(
          mctx, reinterpret_cast<TagGetContainedBlobIdsTask *>(task));
      break;
    }
    case Method::kTagFlush: {
      CHI_CLIENT->DelTask<TagFlushTask>(mctx,
                                        reinterpret_cast<TagFlushTask *>(task));
      break;
    }
    case Method::kGetOrCreateBlobId: {
      CHI_CLIENT->DelTask<GetOrCreateBlobIdTask>(
          mctx, reinterpret_cast<GetOrCreateBlobIdTask *>(task));
      break;
    }
    case Method::kGetBlobId: {
      CHI_CLIENT->DelTask<GetBlobIdTask>(
          mctx, reinterpret_cast<GetBlobIdTask *>(task));
      break;
    }
    case Method::kGetBlobName: {
      CHI_CLIENT->DelTask<GetBlobNameTask>(
          mctx, reinterpret_cast<GetBlobNameTask *>(task));
      break;
    }
    case Method::kGetBlobSize: {
      CHI_CLIENT->DelTask<GetBlobSizeTask>(
          mctx, reinterpret_cast<GetBlobSizeTask *>(task));
      break;
    }
    case Method::kGetBlobScore: {
      CHI_CLIENT->DelTask<GetBlobScoreTask>(
          mctx, reinterpret_cast<GetBlobScoreTask *>(task));
      break;
    }
    case Method::kGetBlobBuffers: {
      CHI_CLIENT->DelTask<GetBlobBuffersTask>(
          mctx, reinterpret_cast<GetBlobBuffersTask *>(task));
      break;
    }
    case Method::kPutBlob: {
      CHI_CLIENT->DelTask<PutBlobTask>(mctx,
                                       reinterpret_cast<PutBlobTask *>(task));
      break;
    }
    case Method::kGetBlob: {
      CHI_CLIENT->DelTask<GetBlobTask>(mctx,
                                       reinterpret_cast<GetBlobTask *>(task));
      break;
    }
    case Method::kTruncateBlob: {
      CHI_CLIENT->DelTask<TruncateBlobTask>(
          mctx, reinterpret_cast<TruncateBlobTask *>(task));
      break;
    }
    case Method::kDestroyBlob: {
      CHI_CLIENT->DelTask<DestroyBlobTask>(
          mctx, reinterpret_cast<DestroyBlobTask *>(task));
      break;
    }
    case Method::kTagBlob: {
      CHI_CLIENT->DelTask<TagBlobTask>(mctx,
                                       reinterpret_cast<TagBlobTask *>(task));
      break;
    }
    case Method::kBlobHasTag: {
      CHI_CLIENT->DelTask<BlobHasTagTask>(
          mctx, reinterpret_cast<BlobHasTagTask *>(task));
      break;
    }
    case Method::kReorganizeBlob: {
      CHI_CLIENT->DelTask<ReorganizeBlobTask>(
          mctx, reinterpret_cast<ReorganizeBlobTask *>(task));
      break;
    }
    case Method::kFlushBlob: {
      CHI_CLIENT->DelTask<FlushBlobTask>(
          mctx, reinterpret_cast<FlushBlobTask *>(task));
      break;
    }
    case Method::kFlushData: {
      CHI_CLIENT->DelTask<FlushDataTask>(
          mctx, reinterpret_cast<FlushDataTask *>(task));
      break;
    }
    case Method::kPollBlobMetadata: {
      CHI_CLIENT->DelTask<PollBlobMetadataTask>(
          mctx, reinterpret_cast<PollBlobMetadataTask *>(task));
      break;
    }
    case Method::kPollTargetMetadata: {
      CHI_CLIENT->DelTask<PollTargetMetadataTask>(
          mctx, reinterpret_cast<PollTargetMetadataTask *>(task));
      break;
    }
    case Method::kPollTagMetadata: {
      CHI_CLIENT->DelTask<PollTagMetadataTask>(
          mctx, reinterpret_cast<PollTagMetadataTask *>(task));
      break;
    }
    case Method::kPollAccessPattern: {
      CHI_CLIENT->DelTask<PollAccessPatternTask>(
          mctx, reinterpret_cast<PollAccessPatternTask *>(task));
      break;
    }
    case Method::kRegisterStager: {
      CHI_CLIENT->DelTask<RegisterStagerTask>(
          mctx, reinterpret_cast<RegisterStagerTask *>(task));
      break;
    }
    case Method::kUnregisterStager: {
      CHI_CLIENT->DelTask<UnregisterStagerTask>(
          mctx, reinterpret_cast<UnregisterStagerTask *>(task));
      break;
    }
    case Method::kStageIn: {
      CHI_CLIENT->DelTask<StageInTask>(mctx,
                                       reinterpret_cast<StageInTask *>(task));
      break;
    }
    case Method::kStageOut: {
      CHI_CLIENT->DelTask<StageOutTask>(mctx,
                                        reinterpret_cast<StageOutTask *>(task));
      break;
    }
  }
}
...
void CopyStart(u32 method, const Task *orig_task, Task *dup_task,
  ...
  switch (method) {
    ...
    case Method::kGetTagId: {
      chi::CALL_COPY_START(reinterpret_cast<const GetTagIdTask *>(orig_task),
                           reinterpret_cast<GetTagIdTask *>(dup_task), deep);
      break;
    }
    case Method::kGetTagName: {
      chi::CALL_COPY_START(reinterpret_cast<const GetTagNameTask *>(orig_task),
                           reinterpret_cast<GetTagNameTask *>(dup_task), deep);
      break;
    }
    case Method::kDestroyTag: {
      chi::CALL_COPY_START(reinterpret_cast<const DestroyTagTask *>(orig_task),
                           reinterpret_cast<DestroyTagTask *>(dup_task), deep);
      break;
    }
    case Method::kTagAddBlob: {
      chi::CALL_COPY_START(reinterpret_cast<const TagAddBlobTask *>(orig_task),
    ...
    case Method::kTagGetSize: {
      chi::CALL_COPY_START(reinterpret_cast<const TagGetSizeTask *>(orig_task),
    ...
    case Method::kTagFlush: {
      chi::CALL_COPY_START(reinterpret_cast<const TagFlushTask *>(orig_task),
    ...
    case Method::kGetBlobId: {
      chi::CALL_COPY_START(reinterpret_cast<const GetBlobIdTask *>(orig_task),
                           reinterpret_cast<GetBlobIdTask *>(dup_task), deep);
      break;
    }
    case Method::kGetBlobName: {
      chi::CALL_COPY_START(reinterpret_cast<const GetBlobNameTask *>(orig_task),
                           reinterpret_cast<GetBlobNameTask *>(dup_task), deep);
      break;
    }
    case Method::kGetBlobSize: {
      chi::CALL_COPY_START(reinterpret_cast<const GetBlobSizeTask *>(orig_task),
    ...
    case Method::kPutBlob: {
      chi::CALL_COPY_START(reinterpret_cast<const PutBlobTask *>(orig_task),
                           reinterpret_cast<PutBlobTask *>(dup_task), deep);
      break;
    }
    case Method::kGetBlob: {
      chi::CALL_COPY_START(reinterpret_cast<const GetBlobTask *>(orig_task),
    ...
    case Method::kDestroyBlob: {
      chi::CALL_COPY_START(reinterpret_cast<const DestroyBlobTask *>(orig_task),
                           reinterpret_cast<DestroyBlobTask *>(dup_task), deep);
      break;
    }
    case Method::kTagBlob: {
      chi::CALL_COPY_START(reinterpret_cast<const TagBlobTask *>(orig_task),
                           reinterpret_cast<TagBlobTask *>(dup_task), deep);
      break;
    }
    case Method::kBlobHasTag: {
      chi::CALL_COPY_START(reinterpret_cast<const BlobHasTagTask *>(orig_task),
    ...
    case Method::kFlushBlob: {
      chi::CALL_COPY_START(reinterpret_cast<const FlushBlobTask *>(orig_task),
                           reinterpret_cast<FlushBlobTask *>(dup_task), deep);
      break;
    }
    case Method::kFlushData: {
      chi::CALL_COPY_START(reinterpret_cast<const FlushDataTask *>(orig_task),
    ...
    case Method::kStageIn: {
      chi::CALL_COPY_START(reinterpret_cast<const StageInTask *>(orig_task),
                           reinterpret_cast<StageInTask *>(dup_task), deep);
      break;
    }
    case Method::kStageOut: {
      chi::CALL_COPY_START(reinterpret_cast<const StageOutTask *>(orig_task),
  ...
  switch (method) {
    ...
    case Method::kGetOrCreateTag: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetOrCreateTagTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kGetTagId: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetTagIdTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kGetTagName: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetTagNameTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kDestroyTag: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const DestroyTagTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kTagAddBlob: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const TagAddBlobTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kTagRemoveBlob: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const TagRemoveBlobTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kTagClearBlobs: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const TagClearBlobsTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kTagGetSize: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const TagGetSizeTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kTagUpdateSize: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const TagUpdateSizeTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kTagGetContainedBlobIds: {
    ...
    case Method::kTagFlush: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const TagFlushTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kGetOrCreateBlobId: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetOrCreateBlobIdTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kGetBlobId: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetBlobIdTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kGetBlobName: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetBlobNameTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kGetBlobSize: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetBlobSizeTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kGetBlobScore: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetBlobScoreTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kGetBlobBuffers: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const GetBlobBuffersTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kPutBlob: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const PutBlobTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kGetBlob: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const GetBlobTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kTruncateBlob: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const TruncateBlobTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kDestroyBlob: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const DestroyBlobTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kTagBlob: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const TagBlobTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kBlobHasTag: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const BlobHasTagTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kReorganizeBlob: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const ReorganizeBlobTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kFlushBlob: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const FlushBlobTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kFlushData: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const FlushDataTask *>(orig_task), dup_task, deep);
      break;
    }
    case Method::kPollBlobMetadata: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const PollBlobMetadataTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kPollTargetMetadata: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const PollTargetMetadataTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kPollTagMetadata: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const PollTagMetadataTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kPollAccessPattern: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const PollAccessPatternTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kRegisterStager: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const RegisterStagerTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kUnregisterStager: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const UnregisterStagerTask *>(orig_task), dup_task,
          deep);
      break;
    }
    case Method::kStageIn: {
      chi::CALL_NEW_COPY_START(reinterpret_cast<const StageInTask *>(orig_task),
                               dup_task, deep);
      break;
    }
    case Method::kStageOut: {
      chi::CALL_NEW_COPY_START(
          reinterpret_cast<const StageOutTask *>(orig_task), dup_task, deep);
      break;
    }
  }
}
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kGetTagId: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetTagIdTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetTagIdTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetTagName: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetTagNameTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetTagNameTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kDestroyTag: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<DestroyTagTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<DestroyTagTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kTagAddBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TagAddBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<TagAddBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kTagRemoveBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TagRemoveBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<TagRemoveBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kTagClearBlobs: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TagClearBlobsTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<TagClearBlobsTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kTagGetSize: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TagGetSizeTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<TagGetSizeTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kTagUpdateSize: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TagUpdateSizeTask>(HSHM_MCTX, task_ptr.shm_);
    ...
    case Method::kTagFlush: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TagFlushTask>(HSHM_MCTX, task_ptr.shm_);
    ...
    case Method::kGetBlobId: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetBlobIdTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetBlobIdTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetBlobName: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetBlobNameTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetBlobNameTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetBlobSize: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetBlobSizeTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetBlobSizeTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetBlobScore: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetBlobScoreTask>(HSHM_MCTX, task_ptr.shm_);
    ...
    case Method::kPutBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<PutBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<PutBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<GetBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<GetBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kTruncateBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TruncateBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<TruncateBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kDestroyBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<DestroyBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<DestroyBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kTagBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<TagBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<TagBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kBlobHasTag: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<BlobHasTagTask>(HSHM_MCTX, task_ptr.shm_);
    ...
    case Method::kFlushBlob: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<FlushBlobTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<FlushBlobTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kFlushData: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<FlushDataTask>(HSHM_MCTX, task_ptr.shm_);
    ...
    case Method::kStageIn: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<StageInTask>(HSHM_MCTX, task_ptr.shm_);
      ar >> *reinterpret_cast<StageInTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kStageOut: {
      task_ptr.ptr_ =
          CHI_CLIENT->NewEmptyTask<StageOutTask>(HSHM_MCTX, task_ptr.shm_);
